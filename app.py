...
class ReusableForm(Form):
    ...
    def InDirecc():
        ...
        if request.method == 'POST':
            ...
            elif request.form['submit_button'] == 'Buscar Supermercados':
                y='supermarket'

            if request.form['submit_button'] == 'Estadisticas':
                return redirect("/estadisticas")

            c.alta(Consulta(direccion=str(direccion), eleccion=str(y)))
    ...
    def estad():
        ...
        if request.method == 'POST':
            ...
            if request.form['button']== 'Hist':
                if c.calcHist():
                    imr='static/rest.png'
                    ims='static/super.png'
                    imh='static/hosp.png'

                return render_template('Estadisticas.html', form=form, imagenr=imr, imagens=ims, imagenh=imh)
